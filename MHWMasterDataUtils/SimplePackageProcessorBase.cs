...
{
    public abstract class SimplePackageProcessorBase<TKey, TValue> : PackageProcessorBase
    {
        ...
        protected SimplePackageProcessorBase(ushort headerValue, Func<Reader, TValue> entryReader, Func<TValue, TKey> keySelector)
        {
